...
pub const ATSPI_DBUS_INTERFACE_EVENT_SCREEN_READER: *const c_char =
    b"org.a11y.atspi.Event.ScreenReader\0" as *const u8 as *const c_char;
...
pub const ATSPI_DBUS_PATH_SCREEN_READER: *const c_char =
    b"/org/a11y/atspi/screenreader\0" as *const u8 as *const c_char;
...
extern "C" {
    ...
    pub fn atspi_accessible_get_accessible_id(
    ...
    pub fn atspi_component_scroll_to(
        obj: *mut AtspiComponent,
        type_: AtspiScrollType,
        error: *mut *mut glib::GError,
    ) -> gboolean;
    pub fn atspi_component_scroll_to_point(
        obj: *mut AtspiComponent,
        coords: AtspiCoordType,
        x: c_int,
        y: c_int,
        error: *mut *mut glib::GError,
    ) -> gboolean;
    ...
    pub fn atspi_text_scroll_substring_to(
        obj: *mut AtspiText,
        start_offset: c_int,
        end_offset: c_int,
        type_: AtspiScrollType,
    ...
    pub fn atspi_text_scroll_substring_to_point(
        obj: *mut AtspiText,
        start_offset: c_int,
        end_offset: c_int,
        coords: AtspiCoordType,
    ...
    pub fn atspi_dbus_server_setup_with_g_main(
        server: *mut gio::GDBusServer,
        context: *mut glib::GMainContext,
    );
