...
const RUST_LAYOUTS: &[(&str, Layout)] = &[
    ...
    (
        "AtspiScrollType",
        Layout {
            size: size_of::<AtspiScrollType>(),
            alignment: align_of::<AtspiScrollType>(),
        },
    ),
    (
        "AtspiStateSet",
...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ...
    (
        ...
        "org.a11y.atspi.Event.ScreenReader",
    ),
    ...
    (
        "ATSPI_DBUS_PATH_SCREEN_READER",
        "/org/a11y/atspi/screenreader",
    ),
