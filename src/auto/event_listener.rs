...
impl EventListener {
    ...
    pub fn deregister_from_callback<P: FnMut(&Event)>(callback: P, event_type: &str) -> Result<(), Error> {
        assert_initialized_main_thread!();
    ...
    //pub fn deregister_no_data<P: FnMut(&Event)>(callback: P, event_type: &str) -> Result<(), Error> {
    //    unsafe { TODO: call atspi_sys:atspi_event_listener_deregister_no_data() }
    //}

    pub fn register_from_callback<P: Fn(&Event) + 'static>(callback: P, event_type: &str) -> Result<(), Error> {
        assert_initialized_main_thread!();
        let callback_data: Box_<P> = Box_::new(callback);
        unsafe extern "C" fn callback_func<P: Fn(&Event) + 'static>(event: *mut atspi_sys::AtspiEvent, user_data: glib_sys::gpointer) {
            let event = from_glib_full(event);
    ...
    //pub fn register_from_callback_full(callback: Option<Box_<dyn Fn(&Event) + 'static>>, event_type: &str, properties: /*Unknown conversion*//*Unimplemented*/Array TypeId { ns_id: 0, id: 28 }) -> Result<(), Error> {
    //    unsafe { TODO: call atspi_sys:atspi_event_listener_register_from_callback_full() }
    //}

    //pub fn register_no_data<P: Fn(&Event) + 'static>(callback: P, event_type: &str) -> Result<(), Error> {
    //    unsafe { TODO: call atspi_sys:atspi_event_listener_register_no_data() }
    //}
}
...
pub trait EventListenerExt: 'static {
    fn deregister(&self, event_type: &str) -> Result<(), Error>;

    fn register(&self, event_type: &str) -> Result<(), Error>;

    //fn register_full(&self, event_type: &str, properties: /*Unknown conversion*//*Unimplemented*/Array TypeId { ns_id: 0, id: 28 }) -> Result<(), Error>;
}
...
impl<O: IsA<EventListener>> EventListenerExt for O {
    ...
    //fn register_full(&self, event_type: &str, properties: /*Unknown conversion*//*Unimplemented*/Array TypeId { ns_id: 0, id: 28 }) -> Result<(), Error> {
    //    unsafe { TODO: call atspi_sys:atspi_event_listener_register_full() }
    //}
}
